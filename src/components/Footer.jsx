      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a href="#!" className="text-gray-600">Laboral</a>
            </p>
            <p className="mb-4">
              <a href="#!" className="text-gray-600">Penal</a>
            </p>
            <p className="mb-4">
              <a href="#!" className="text-gray-600">Civil</a>
            </p>
            <p>
              <a href="#!" className="text-gray-600">Comercial</a>
            </p>
          </div>
